...
(function () {
  ...
  const SignUpForm = {
    ...
    bindFieldValidation: () => {
      ...
      if (firstName) {
        firstName.addEventListener('blur', () => SignUpForm.validateFirstName());
      ...
      if (password) {
        ...
        password.addEventListener('focus', () => {
          const container = document.getElementById('signup-passwordStrengthContainer');
      ...
      if (coachEmail) {
        coachEmail.addEventListener('blur', () => SignUpForm.validateCoachEmail());
    ...
    bindRoleChange: () => {
      ...
      const coachSelectionGroup = document.getElementById('signup-coachSelectionGroup');
      ...
      if (noCoachRadio && coachEmailGroup) {
        noCoachRadio.addEventListener('change', (e) => {
          if (e.target.checked) {
            ...
            const coachEmailInput = document.getElementById('signup-coachEmail');
    ...
    validateFirstName: () => {
      ...
      if (!value) {
        ValidationUtils.showFieldError('signup-firstName', 'First name is required');
        SignUpForm.validationState.firstName = false;
        return false;
      }
    ...
    validateLastName: () => {
      ...
      if (!value) {
        ValidationUtils.showFieldError('signup-lastName', 'Last name is required');
        SignUpForm.validationState.lastName = false;
        return false;
      }
    ...
    validatePassword: () => {
      ...
      const value = password.value;
      if (!value) {
        ValidationUtils.showFieldError('signup-password', 'Password is required');
        SignUpForm.validationState.password = false;
        return false;
      }
    ...
    validateRole: () => {
      ...
      if (!value) {
        ValidationUtils.showFieldError('signup-role', 'Please select your role');
        SignUpForm.validationState.role = false;
        return false;
      }
    ...
    validateCoachEmail: () => {
      ...
      const value = coachEmail.value.trim();
      if (!value) {
        ValidationUtils.showFieldError('signup-coachEmail', 'Coach email is required');
        SignUpForm.validationState.coachEmail = false;
        return false;
      }
    ...
    handleSubmit: async (e) => {
      ...
      const loadingText = document.querySelector('.loading-text-centered');
